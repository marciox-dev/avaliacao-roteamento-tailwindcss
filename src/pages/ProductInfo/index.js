      ...
      <div className='flex flex-col justify-center items-center h-screen pt-32'>
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10'>
          <div className='order-2 md:order-1 lg:order-1 flex flex-col justify-center'>
            <h1 className='text-center md:text-left lg:text-left text-3x1 lg:text-4x1 font-semibold poppins pb-4 text-gray-700 select-none'>
              {product.nome}</h1>
            ...
            <div className='flex items-center justify-center md:justify-start lg:justify-start space-x-6 pt-8'>
              <h2 className='text-3x1 font-bold text-black poppins select-none'>R$ {product.precoUnitario}</h2>
              <div className='flex items-center border border-gray-200 px-4 py-2 space-x-6 rounded-full'>
                <AiOutlineMinusSquare onClick={() => {
                  ...
                  className='text-2x1 w-8 h-8 rounded-full text-orange-600 hover:scale-105 transform transition duration-500 cursor-pointer p-1' />
                <span className='texxt-lg text-gray-700 poppins select-none'>{quantity}</span>
            ...
            <div className='mt-8 flex items-center justify-center md:justify-start lg:justify-start'>
              <button onClick={addToCart} className='flex items-center space-x-3 bg-primary px-6 py-3 poppins rounded-full ring-red-300 text-white focus:outline-none focus:ring-4 transform transition duration-700 hover:scale-lg'>
          ...
          <div className='order-1 md:order-2 lg:order-2'>
            <img src={product.imagem} alt='' className='w-2/4 md:w-3/4 lg:w-full mx-auto' />
          </div>
        </div>
      </div>
    </main>
